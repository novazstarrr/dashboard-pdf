...
import { Card, Button, Form, ListGroup, Pagination, Nav } from 'react-bootstrap';
import { toast } from 'react-toastify';
import { Link } from 'react-router-dom';
import useUsers from '../hooks/useUsers';
import UserFormModal from './UserFormModal.jsx'; // Import the external modal
...
export const UserManagement = () => {
  ...
  return (
    <div className="flex-grow-1" style={{ background: '#f5f5f5' }}>
      <div className="py-4">
        <Nav variant="tabs" defaultActiveKey="/user-management" className="mb-4">
          <Nav.Item>
            <Nav.Link as={Link} to="/dashboard">Dashboard</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link active>User Management</Nav.Link>
          </Nav.Item>
        </Nav>
