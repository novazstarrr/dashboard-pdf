...
export const Dashboard = () => {
  ...
  useEffect(() => {
    const handler = setTimeout(() => {
      if (fileSearchTerm) {
        fetchSearchResults(fileSearchTerm);
      } else {
        fetchUserFiles();
      }
    }, 300); 
  ...
  }, [fileSearchTerm, fetchSearchResults, fetchUserFiles]);
          ...
          <Col xs={12} md={6} lg={8}>
            <Card className="shadow-sm h-100">
              <Card.Body>
                ...
                <SearchBar searchTerm={fileSearchTerm} onSearch={handleSearch} />
                ...
                {isLoading ? (
                  ...
                  <>
                    <ListGroup>
                      ...
                      {userFiles.length === 0 && (
                        <ListGroup.Item>
                          {fileSearchTerm ? 'No matching files found' : 'No files uploaded yet'}
                        </ListGroup.Item>
                      )}
                    </ListGroup>
                    ...
                    {!fileSearchTerm && (
                      <div className="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <Pagination>
                          ...
                          {[...Array(Math.max(1, totalPages))].map((_, idx) => (
                            <Pagination.Item
                              key={idx + 1}
                              active={idx + 1 === page}
